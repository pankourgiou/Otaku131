...
for i in range(10):
    ...
    if player1_value > player2_value:
        print("player 1 wins-->You can listen Dream theater music")
        player1_score = player1_score + 1  # This is how we increment a variable
    elif player2_value > player1_value:
        print("player 2 wins-->You can listen Iron Maiden music")
        player2_score = player2_score + 1
    else:
        print("It's a draw-->Listen both Dream theater and Iron Maiden music")
